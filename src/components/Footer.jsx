...
const Footer = () => {
  return (
    <footer className="py-8 mb-0 text-white bg-black">
      <div className="container grid w-full grid-cols-1 gap-8 mx-auto md:grid-cols-4">
        <div>
        ...
        <div>
          ...
          <form className="mt-4">
            <input
              ...
              className="w-full p-2 mb-4 bg-black border-b border-white border-solid focus:outline-none"
            />
            <button
              type="submit"
