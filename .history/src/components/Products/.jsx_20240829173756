...
import CityStepThrough26_8SpeedImage from '../../assets/Products-Images/CityStepThrough26-8Speed.jpeg'; // Ensure the correct file extension

const CityStepThrough26_8Speed = () => {
  return (
    <div className="text-center">
      <img src={CityStepThrough26_8SpeedImage} alt="City Step-Through 26\" 8-Speed" className="mx-auto mb-4" /> {/* Use the correct variable */}
